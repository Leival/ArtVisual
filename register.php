...
if (isset($_POST['submit'])) {
	...
	if ($password == $cpassword) {
		...
		if (!$result->num_rows > 0) {
			$sql = "INSERT INTO artista (username, email, password)
	...
	<div class="container">
		<form action="" method="POST" class="login-email">
			...
			<div class="input-group">
				<input type="text" placeholder="Nombre de Artista" name="username" value="<?php echo $username; ?>" required>
			</div>
			<div class="input-group">
			...
			<p class="login-register-text">Ya Tienes una Cuenta? <a href="index.php">Inicia Sesion</a>.</p>
		</form>
	</div>
</body>
</html>